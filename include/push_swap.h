...
/*   Updated: 2025/02/21 19:18:03 by mprunty          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#ifndef PUSH_SWAP_H
# define PUSH_SWAP_H
...
// ../src/chunks.c
t_dll	*get_chunk(t_dll **lst, t_loc_e loc);
void	set_chunks(t_dll **lst, int size, t_loc_e loc, t_idx curr_range);
t_dll	*get_chunks(t_dll **lst, t_loc_e loc);
t_idx	*get_range(t_dll **stack, t_loc_e loc);
t_dll	*ft_chunk(t_dll **lst, t_loc_e loc);
...
// ../src/loc.c
t_loc_e	set_destination(t_loc_e loc, int finidx, t_idx range);
